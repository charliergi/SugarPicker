   ...
   fun{MyFunction Map}
	 ...
	 fun{Determine Ru Dx1 Dy1 Dx2 Dy2 Dx3 Dy3 Dx4 Dy4}
	    case Ru of H|T then
		  ...
		  {Determine RU plus(Dx1 X) plus(Dy1 Y) plus(Dx2 X) plus(Dy2 Y) plus(Dx3 X) plus(Dy3 Y) plus(Dx4 X) plus(Dy4 Y)}
		  |{Determine T Dx1 Dy1 Dx2 Dy2 Dx3 Dy3 Dx4 Dy4}
	       [] scale(rx:X ry:Y 1:RU) then
		  {Determine RU mult(Dx1 X) mult(Dy1 Y) mult(Dx2 X) mult(Dy2 Y) mult(Dx3 X) mult(Dy3 Y) mult(Dx4 X) mult(Dy4 Y)}
		  |{Determine T Dx1 Dy1 Dx2 Dy2 Dx3 Dy3 Dx4 Dy4}
